...
$ReleaseNotes = @(
    'CodeDaoLab: Qingyun Chapter - Godot Edition v0.2.1',
    '',
    ...
    'V0.2.1: WASD/arrow movement, four-step onboarding, directional guidance and precise output diagnostics.'
) -join "`r`n"
...
$ZipPath = Join-Path $DistDir "$BaseName-v0.2.1.zip"
