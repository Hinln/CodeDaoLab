...
- **可探索世界**：青云宗 / 青云城 / 后山秘境 3 区域、14 个地点组成连通地图，移动、地点解锁与 NPC 在场状态全部持久化。
...
> V0.3 已完成：可探索世界地图、NPC 好感度与关系、章节剧情、5 个宗门支线、8 种随机奇遇、13 门功法熟练度与演武场考核、长期成长总览。
...
| 数据 | JSON 数据驱动：课程 / 任务 / 世界 / 剧情 / NPC / 对话 / 功法 / 秘境 / 成就 / 道具 |
...
| 测试 | pytest（后端单元 / 集成，268 项通过）+ playwright-core E2E（V0.3 前端全流程）+ 发行构建冒烟 |
...
| `docs/V0.3_ACCEPTANCE.md` | V0.3 最终验收清单 |
| `docs/V0.3_TEST_REPORT.md` | V0.3 测试报告 |
| `CHANGELOG.md` | 版本更新日志 |
